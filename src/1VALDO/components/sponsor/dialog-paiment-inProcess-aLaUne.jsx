...
export default function DialogPaimentInProcessALaUne( { showDialog, dataGet, updateDataAfterSucces } )
{
       ...
       useEffect( () => { if ( showDialog.value ) { dispatch( request( { ...dataGet, aLaUne: true } ) ) } }, [ showDialog, dispatch, dataGet ] );
...
DialogPaimentInProcessALaUne.propTypes = {
