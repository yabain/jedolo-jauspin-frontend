...
import { useUpdate } from 'src/1VALDO/hook/user/edit';
...
export default function DialogEdit( { showDialog, dataGet, updateDataAfterSucces } )
{
       ...
       useUpdate( resetAfterSuccess, updateDataAfterSucces )
