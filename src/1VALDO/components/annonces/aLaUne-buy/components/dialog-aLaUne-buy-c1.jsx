...
export default function DialogALaUneBuyComponent1({ items, taxes, shipping, discount, subTotal }) {
          ...
          >
            ...
            <ListItemText
              ...
              secondary={
                <Box>
                  {item.validite && (
                    <Typography variant="subtitle1" color="text.secondary" sx={{ color: 'black', display: 'block', mt: { xs: 3, sm: 0.2 } }}>
...
DialogALaUneBuyComponent1.propTypes = {
