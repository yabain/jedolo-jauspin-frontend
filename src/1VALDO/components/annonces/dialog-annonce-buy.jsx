...
export default function DialogAnnonceBuy({ showDialog, dataGet, updateDataAfterSucces }) {
  ...
  const passObject = useMemo(() => ({ id: 1, titre: dataGet.name, montant: 10, description: dataGet.subDescription }), [dataGet.subDescription, dataGet.name]);
