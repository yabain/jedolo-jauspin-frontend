...
import { request, resetAfterRequest } from "src/store/annonces/getLastAnnoncesPostNbr/reducer";
...
export function useGet( handleGet, isActive = true, showEmque = false )
{
       ...
       const { data, isFulled, isPending, isError } = useSelector( ( state ) => state.getLastAnnoncesPostNbr );
       ...
       const handleEnque = useCallback( () => enqueueSnackbar( "Nombre de nouvelle annonces recuperer avec success !" ), [ enqueueSnackbar ] )
