...
const fulfilledAction = ( state, action ) => 
{
       ...
       console.log( 'requette transaction executer avec succès:', action.payload );
}
...
export const addSlice = createSlice( {
       name: 'addTransaction', extraReducers: requestCases,
...
export const request = createAsyncThunk( 'addTransaction', async ( data ) => service.request( data ) )
