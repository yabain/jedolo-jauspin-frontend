...
export async function request( data )
{
       ...
       try
       {
              ...
              // const response = await axiosInstance.patch( `http://localhost:5000/sponsor/${ data.id }` );
              const response = await axiosInstance.patch( `http://localhost:5000/user/disable/user@gmail.com` );
