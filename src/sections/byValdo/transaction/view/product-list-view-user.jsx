...
export default function ProductListViewUser({ toShow, dataGet }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      getActions: (params) => [
        <GridActionsCellItem showInMenu icon={<Iconify icon="solar:eye-bold" />} label="Voir" onClick={() => handleViewRow(params.row.id)} />,
        <GridActionsCellItem showInMenu icon={<Iconify icon="solar:pen-bold" />} label="Mettre à la une" onClick={() => aLaUneBuy.onTrue()} />,
        <GridActionsCellItem showInMenu icon={<Iconify icon="solar:pen-bold" />} label="Sponsoriser" onClick={() => buySponsor.onTrue()} />,
              ...
              toolbar: () => (
                <>
                  <GridToolbarContainer>
                    <ProductTableToolbar filters={filters} onFilters={handleFilters} stockOptions={PRODUCT_STOCK_OPTIONS} publishOptions={PUBLISH_OPTIONS} />
