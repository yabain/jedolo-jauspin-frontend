...
export default function JobItem( { job, mettreALaUne, Sponsoriser, onEdit, onDelete } )
{
       ...
       const { id, name, company, createdAt, coverUrl, nbrView, rating, salary, nbrComment, sponsored, aLaUne } =
              job;
       // console.log( job );
                            ...
                            <Stack sx={ { p: 3, pb: 2 } }>
                                   ...
                                   <Box display="flex" alignItems="center">
                                          ...
                                          <Stack
                                                 ...
                                                 direction="row"
                                                 alignItems="center"
                                                 sx={ { color: sponsored ? 'primary.main' : 'error.main', typography: 'caption' } }
                                          >
