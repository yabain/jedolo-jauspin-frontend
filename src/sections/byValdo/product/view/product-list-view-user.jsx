...
import { RenderCellStock, RenderCellPrice, RenderCellPublish, RenderCellProduct, RenderCellCreatedAt, RenderCellNbrComment, RenderCellProductXs, RenderCellALaUne, RenderCellSponsored } from '../product-table-row';
...
export default function ProductListViewUser({ toShow }) {
  ...
  }, [dispatch, annonceList, user, isGetingSuccess, isGeting, toShow, isError]);
  ...
  const columns = [
    ...
    },
    {
      ...
      getActions: (params) => [
        ...
        // />,
        <GridActionsCellItem showInMenu icon={<Iconify icon="solar:pen-bold" />} label="Editer" onClick={() => handleEditRow(params.row)} />,
        <GridActionsCellItem
          showInMenu
  ...
  return (
    <>
      <DialogALaUneBuy showDialog={aLaUneBuy} dataGet={annonceClick} />
